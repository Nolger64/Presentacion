...
BUTSPANISH.addEventListener('click', () => {
    if(idioma == 0){
        ...
        textAbout2.innerHTML = "I am a diligent Junior system engineer with 6 years of experience in web applications development. I am eager to join a tech company that builds out-of-the-box solutions for regional clients. I am skilled in developing plans, managing projects, and user documentation.";
